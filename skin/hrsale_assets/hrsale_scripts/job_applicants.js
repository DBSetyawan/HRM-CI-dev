...
var xin_table = $('#xin_table').dataTable({
	"bDestroy": true,
	"ajax": {
		url : base_url+"/applicants_list/"+$('#job_id').val(),
		type : 'GET'
	},
...
$.ajax({
	url :  base_url+"/read_application/",
	type: "GET",
	data: 'jd=1&is_ajax=1&mode=modal&type=applicant&data=view_application_status&edit=status&application_id='+application_id,
	success: function (response) {
		if(response) {
