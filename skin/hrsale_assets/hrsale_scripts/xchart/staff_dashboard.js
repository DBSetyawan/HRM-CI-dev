$(window).on("load", function(){	
	var ctx = $("#employee_company");
	Chart.defaults.global.legend.display = false;
	$.ajax({
		url: site_url+'dashboard/employee_company/',
...
$(window).on("load", function(){	
	var ctx = $("#employee_location");
	Chart.defaults.global.legend.display = false;
	$.ajax({
		url: site_url+'dashboard/employee_location/',
		contentType: "application/json; charset=utf-8",
		dataType: "json",
		success: function(response) {
		var bgcolor = [];
...
$(window).on("load", function(){	
	...
	Chart.defaults.global.legend.display = false;
	$.ajax({
		url: site_url+'dashboard/employee_department/',
		contentType: "application/json; charset=utf-8",
		dataType: "json",
		success: function(response) {
		var bgcolor = [];
