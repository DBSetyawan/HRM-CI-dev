...
$( document ).on( "click", ".delete", function() {
	...
	$('#delete_record').attr('action',base_url+'/ticket_comment_delete/'+$(this).data('record-id'));
});
/// delete a file
$( document ).on( "click", ".delete-file", function() {
	$('input[name=_token_del_file]').val($(this).data('record-id'));
	$('#delete_record_f').attr('action',base_url+'/ticket_attachment_delete/'+$(this).data('record-id'));
});