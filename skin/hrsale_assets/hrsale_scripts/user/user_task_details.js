...
// On page load: datatable
 var xin_comment_table = $('#xin_comment_table').dataTable({
	"bDestroy": true,
	"ajax": {
		url : base_url+"/task_comments_list/"+$('#comment_task_id').val(),
		type : 'GET'
	},
...
var xin_attachment_table = $('#xin_attachment_table').dataTable({
	"bDestroy": true,
	"ajax": {
		url : base_url+"/task_attachment_list/"+$('#c_task_id').val(),
		type : 'GET'
	},
	"fnDrawCallback": function(settings){
	$('[data-toggle="tooltip"]').tooltip();          
...
$( document ).on( "click", ".delete", function() {
	...
	$('#delete_record').attr('action',base_url+'/task_comment_delete/'+$(this).data('record-id'));
});
/// delete a file
$( document ).on( "click", ".delete-file", function() {
	$('input[name=_token_del_file]').val($(this).data('record-id'));
	$('#delete_record_f').attr('action',base_url+'/task_attachment_delete/'+$(this).data('record-id'));
});