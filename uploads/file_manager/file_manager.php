                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://fatihtechnosolusindo.com/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Adhi Monako</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Anune Maho';      $tr['en']['AppTitle']           = 'File Manager';
