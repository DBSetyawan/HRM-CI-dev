...
if ( ! function_exists('get_employee_leave_category'))
{
	function get_employee_leave_category($id_nums,$employee_id) {
		$CI =&	get_instance();
		$sql = "select e.leave_categories,e.user_id,l.Jenis,l.Maksimum,l.Nama from xin_employees as e, masterijin as l where l.Jenis IN ($id_nums) and e.user_id = $employee_id";
