...
class Theme extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	public function page_layouts() {
		...
		if($this->input->post('page_header')==='') {
        	$Return['error'] = $this->lang->line('xin_error_thm_page_header');
		} else if($this->input->post('footer_layout')==='') {
        	$Return['error'] = $this->lang->line('xin_error_thm_footer_layout');
		} else if($this->input->post('statistics_cards')==='') {
        	$Return['error'] = $this->lang->line('xin_error_thm_statistics_cards');
		} else if($this->input->post('animation_style')==='') {
        	$Return['error'] = $this->lang->line('xin_header_menu_animation_style_error_field');
		} else if($this->input->post('theme_option')==='') {
        	$Return['error'] = $this->lang->line('xin_hrsale_themes_options_error_field');
		...
		'footer_layout' => $this->input->post('footer_layout'),
		'statistics_cards' => $this->input->post('statistics_cards'),
		'animation_style' => $this->input->post('animation_style'),
		'theme_option' => $this->input->post('theme_option'),
		...
		'sub_menu_icons' => $this->input->post('sub_menu_icons'),
		);
