    ...
    public function leads_list() {
		...
		$data = array();
          ...
          foreach($leads->result() as $r) {
			...
			// change to client
			if($r->is_changed == '0'){
				$change = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_change_to_client').'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light" data-toggle="modal" data-target=".add-modal-data" data-lead_id="'. $r->client_id . '"><span class="fa fa-exchange"></span></button></span>';
			...
			if($r->is_changed == 0){
			$dview = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_lead_add_followup').'"><a href="'.site_url().'admin/leads/followup/'.$r->client_id.'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
			} else {
				$dview = '';
			}
	 ...
	 public function leads_followup_list() {
		...
		$data = array();
          ...
          foreach($followup->result() as $r) {
			...
			$delete = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_delete').'"><button type="button" class="btn icon-btn btn-xs btn-danger waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->leads_followup_id . '"><span class="fa fa-trash"></span></button></span>';
			$edit = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_edit').'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"  data-toggle="modal" data-target=".view-modal-data"  data-leads_followup_id="'. $r->leads_followup_id . '"><span class="fa fa-pencil"></span></button></span>';
			$combhr = $edit.$delete;
