...
class Announcement extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$this->Xin_model->update_announcements_record($edata);
    ...
    public function announcement_list()
     {
		...
		$ititle = $r->title.'<br><small class="text-muted"><i>'.$this->lang->line('xin_published_for').': '.$location_name.'('.$department_name.')'.'<i></i></i></small><br><small class="text-muted"><i>'.$r->summary.'<i></i></i></small>';
		$data[] = array(
			$combhr,
			$ititle,
			$comp_name,
	 ...
	 public function read()
	{
		...
		$data = array(
				...
				'photo_announcement' => $result[0]->photo_announcement,
  ...
  //      		$Return['error'] = $this->lang->line('xin_error_summary_field');
		...
		'photo_announcement' => $this->input->post('photo_announcement'),
		'is_notify' => 1,
