...
<div class="row">
  <div class="col-md-4 col-12">
    <div class="box box-body bg-hr-warning">
      <div class="flexbox"> <span class="fa fa-user text-primary font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo $this->Clients_model->get_total_clients();?></span> </div>
      <div class="text-right">Total Clients</div>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="box box-body bg-hr-warning">
      <div class="flexbox"> <span class="fa fa-street-view text-danger font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo $this->Clients_model->get_total_client_convert();?></span> </div>
      <div class="text-right">Lead to Clients</div>
    </div>
  </div>
</div>
