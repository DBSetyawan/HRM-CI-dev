        ...
        <div class="box">
          <div class="box-body">
            ...
            <div class="list-group" id="list_group">
              <span class="list-group-item calendar-options text-green hrsale-drag-option" data-record="0"> <i class="ion ion-thumbsup"></i> <?php echo $this->lang->line('xin_invoice_completed');?></span>
              <span class="list-group-item calendar-options text-yellow hrsale-drag-option" data-record="0"> <i class="fa fa-calendar-o"></i> <?php echo $this->lang->line('xin_invoice_pending');?></span>
            </div>  
            </div>
            <div class="box-body">
