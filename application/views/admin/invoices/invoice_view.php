...
<div class="row">
  <div class="col-xs-12"> &nbsp; <small class="pull-right">
    <div class="btn-group pull-right" role="group" style="margin-top:2px">
      ...
      <button type="button" class="btn icon-btn btn-xs btn-success waves-effect waves-light"  data-toggle="modal" data-target=".add-modal-data"  data-invoice_id="<?php echo $invoice_id; ?>"><span class="fa fa-exchange"></span> <?php echo $this->lang->line('xin_invoice_pay');?></button>
  ...
  <div id="print_invoice_hr"> 
    ...
    <div class="row invoice-info">
      ...
      <div class="col-sm-4 invoice-col"> <b><?php echo $this->lang->line('xin_invoice_no');?> <?php echo $invoice_number;?></b><br>
        <b>P.O. No:</b> <?php echo $project_no;?><br>
        <b>VAT REG. NO:</b> <?php echo $government_tax;?><br>
