...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_travel');?></h4>
</div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Purpose of Visit<?php echo $this->lang->line('xin_visit_purpose');?>" name="visit_purpose" type="text" id="visit_purpose">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var myEvent = {
					  travel_id: JSON.re_last_id,
					  title: $('#visit_purpose').val(),
