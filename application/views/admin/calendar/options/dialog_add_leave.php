...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('left_leave');?></h4>
</div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control" name="leave_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_leave_type');?>">
                ...
                <option value="<?php echo $type->Jenis;?>"> <?php echo $type->Nama;?></option>
                <?php } ?>
              </select>
            </div>
