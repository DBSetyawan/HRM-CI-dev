    ...
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        <tr>
          ...
          <td style="display: table-cell;"><?php echo $task_catname;?></td>
        </tr>
        <tr>
        ...
        <div class="form-group">
         <?php $task_categories = $this->Project_model->get_task_categories(); ?>
          ...
          <select class="form-control" name="task_name" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_title');?>">
            ...
            <option value="<?php echo $task_cat->task_category_id;?>" <?php if($task_name == $task_cat->task_category_id):?> selected="selected"<?php endif;?>> <?php echo $task_cat->category_name;?></option>
            <?php } ?>
          </select>
        </div>
        <div class="row">
