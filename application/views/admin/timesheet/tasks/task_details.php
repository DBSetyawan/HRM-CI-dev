...
<?php $task_cat = $this->Project_model->read_task_category_information($task_name); ?>
<?php
if(!is_null($task_cat)){
                ...
                <table class="datatables-demo table table-striped table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td class="text-right"><?php echo $task_catname;?></td>
                    </tr>
                    <tr>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="Status">
                          ...
                          <option value="3" <?php if($task_status=='3'):?> selected <?php endif; ?>><?php echo $this->lang->line('xin_project_cancelled');?></option>
                          <option value="4" <?php if($task_status=='4'):?> selected <?php endif; ?>><?php echo $this->lang->line('xin_project_hold');?></option>
                        </select>
                      </div>
                    </div>
                  </div>
