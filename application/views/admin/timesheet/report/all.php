      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          ...
          <tr>
            ...
            <th style="width:120px;">No Kontak</th>
...
$(function(){
    ...
    var xin_table = $('#xin_table').dataTable({
        "bDestroy": true,
        "ajax": {
            url : site_url+"timesheetreport/all_list/?attendance_date="+$('#attendance_date').val(),
            type : 'GET'
        },
        dom: 'lBfrtip',
...
$("#attendance_daily_report").submit(function(e){
    ...
    $('#att_date').html(date_format);
         var xin_table2 = $('#xin_table').dataTable({
            "bDestroy": true,
            "ajax": {
                url : site_url+"timesheetreport/all_list/?attendance_date="+$('#attendance_date').val()+"&location_id="+$('#location_id').val(),
                type : 'GET'
            },
