...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title">
        Laporan Pegawai Tidak Login Per Koordinator
    </h3>
  </div>
  <div class="box-body">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th style="width:120px;">Jumlah Belum Shareloc</th>
          </tr>
        </thead>
      </table>
    </div>
...
$(function(){
    ...
    var xin_table = $('#xin_table').dataTable({
        "bDestroy": true,
        "ajax": {
            url : site_url+"timesheetreport/get_notloginkoor/?attendance_date="+$('#attendance_date').val(),
            type : 'GET'
        },
        dom: 'lBfrtip',
