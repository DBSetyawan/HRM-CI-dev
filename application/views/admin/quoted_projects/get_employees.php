...
<div class="form-group">
  <label for="xin_project_manager"><?php echo $this->lang->line('xin_project_manager');?></label>
   <select multiple="multiple" name="assigned_to[]" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_project_manager');?>">
