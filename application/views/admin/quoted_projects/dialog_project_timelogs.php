...
<?php echo form_open('admin/quoted_projects/update_project_timelog/'.$timelogs_id, $attributes, $hidden);?>
	...
	$.ajax({
		...
		success: function (JSON) {
			if (JSON.error != '') {
				...
				"bDestroy": true,
				"ajax": {
					url : "<?php echo site_url('admin/quoted_projects/project_timelogs_list');?>/<?php echo $project_id;?>",
					type : 'GET'
				},
