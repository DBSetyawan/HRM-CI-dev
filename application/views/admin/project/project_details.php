    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><p><?php echo $this->lang->line('xin_start_date');?></p></h5>
                    <span class="text-muted"><?php echo $this->Xin_model->set_date_format($start_date);?></span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><p><?php echo $this->lang->line('xin_end_date');?></p></h5>
                    <span class="text-muted"><?php echo $this->Xin_model->set_date_format($end_date);?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <span><?php echo $this->lang->line('xin_project_no');?></span>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="card-body">
        <div class="row m-t-20">
          ...
          <div class="col-md-2">
              ...
              <div class="col-md-2">
                <h5 class=""><?php echo $this->lang->line('xin_project_budget_hrs');?></h5>
                <p class="text-muted"><?php echo $budget_hours;?></p>
              </div>
           <?php $actual_hours = $this->Xin_model->actual_hours_timelog($project_id); ?>
           <div class="col-md-2">
            <h5 class=""><?php echo $this->lang->line('xin_project_actual_hrs');?></h5>
            <p class="text-muted"><?php echo $actual_hours;?></p>
          </div>
          <div class="col-md-4">
...
<section id="basic-listgroup">
  <div class="row match-heights <?php echo $get_animate;?>">
    ...
    <div class="col-xl-10 col-lg-10  <?php echo $get_animate;?>">
      ...
      <div class="col current-tab <?php echo $get_animate;?>" id="variations"  aria-expanded="false" style="display:none;">
        <div class="box md-4">
          <div class="box-header with-border">
            <h3 class="box-title"> <?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_project_variation');?></h3>
            <div class="box-tools pull-right"> <a class="text-dark collapsed" data-toggle="collapse" href="#add_vform" aria-expanded="false">
        <button type="button" class="btn btn-xs btn-primary"> <span class="ion ion-md-add"></span> <?php echo $this->lang->line('xin_add_new');?></button>
        </a> </div>
          </div>
          <div id="add_vform" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
          <div class="box-body">
            <?php $attributes = array('name' => 'add_variation', 'id' => 'xin-variation-form', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
            <?php $hidden = array('_method' => 'ADD');?>
            <?php echo form_open('admin/timesheet/add_project_variation/', $attributes, $hidden);?>
            <?php
			$data7 = array(
			  'name'        => 'user_id',
			  'type'        => 'hidden',
            ...
            <div class="box-block">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_project_variation_no');?>" name="variation_no" type="text" value="">
                      </div>
                    </div>
                 </div> 
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_project_variation_hrs');?>" name="variation_hour" type="text" value="">
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="description"><?php echo $this->lang->line('xin_description');?></label>
                    <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_description');?>" name="description" cols="30" rows="15" id="vdescription"></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="client_approval" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_client_approval');?>">
                      <option value="0"><?php echo $this->lang->line('xin_client_approval_unclaimed');?></option>
                      <option value="1"><?php echo $this->lang->line('xin_client_approval_claimed');?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-9">
        ...
        <div class="box mt-4 <?php echo $get_animate;?>">
          <div class="box-header with-border">
            <h3 class="box-title"> <?php echo $this->lang->line('xin_project');?> <?php echo $this->lang->line('xin_project_variations');?> </h3>
          </div>
          <div class="box-body">
            <div class="box-datatable table-responsive">
              <table class="table table-striped table-bordered dataTable" id="xin_variation_table" style="width:100%;">
                <thead>
                  <tr>
                    <th><?php echo $this->lang->line('xin_action');?></th>
                    <th><?php echo $this->lang->line('dashboard_xin_title');?></th>
                    <th><?php echo $this->lang->line('xin_project_variation_no');?></th>
                    <th><?php echo $this->lang->line('xin_e_details_date');?></th>
                    <th><?php echo $this->lang->line('xin_assigned_to');?></th>
                    <th><?php echo $this->lang->line('xin_client_approval');?></th>
                  </tr>
                </thead>
              </table>
            </div>
