...
{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('let_staff');?>",  add_info: "", check: "<?php if(isset($_GET['role_id'])) { if(in_array('103',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", value: "103",  items: [
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('hr_staff_dashboard_title');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "422", check: "<?php if(isset($_GET['role_id'])) { if(in_array('422',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_download_profile_title');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "421", check: "<?php if(isset($_GET['role_id'])) { if(in_array('421',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ 
		...
		items: [
					{ 
						...
						value: "28", check: "<?php if(isset($_GET['role_id'])) { if(in_array('28',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",
						items: [
					...
					{ 
						id: "", class: "role-checkbox-modal",
						text: "<?php echo $this->lang->line('left_attendance');?> Log",  
						add_info: "<?php echo $this->lang->line('xin_view');?>", 
						value: "991",check: "<?php if(isset($_GET['role_id'])) { if(in_array('991',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"
					},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('hr_timesheet_dashboard_title');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "423",check: "<?php if(isset($_GET['role_id'])) { if(in_array('423',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_attendance_timecalendar');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "261",check: "<?php if(isset($_GET['role_id'])) { if(in_array('261',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_leave_status');?>",  add_info: "<?php echo $this->lang->line('xin_leave_status');?>", value: "31", check: "<?php if(isset($_GET['role_id'])) { if(in_array('31',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('hr_project_dashboard_title');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "312",check: "<?php if(isset($_GET['role_id'])) { if(in_array('312',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
...
{ id: "", class: "role-checkbox-modal",text: "<?php echo $this->lang->line('xin_acc_accounts');?>", check: "<?php if(isset($_GET['role_id'])) { if(in_array('71',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "",value: "71",  items: [
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('hr_accounting_dashboard_title');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "286",check: "<?php if(isset($_GET['role_id'])) { if(in_array('286',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_payslip_history');?>",  add_info: "<?php echo $this->lang->line('xin_view_payslip');?>", value: "37", check: "<?php if(isset($_GET['role_id'])) { if(in_array('37',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
	...
	{ id: "", class: "role-checkbox-modal",text: "<?php echo $this->lang->line('xin_acc_accounts').' '.$this->lang->line('xin_acc_reports');?>", check: "<?php if(isset($_GET['role_id'])) { if(in_array('82',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "",value: "82",  items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_hr_imports');?>",  add_info: "<?php echo $this->lang->line('xin_import_employees');?>", value: "92", check: "<?php if(isset($_GET['role_id'])) { if(in_array('92',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
