...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="<?php if(!empty($arr_mod['active']))echo $arr_mod['ddopen'];?> treeview"> <a href="#"> <i class="fa fa-dashboard"></i> <span><?php echo $this->lang->line('dashboard_title');?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">
        <li class="sidenav-link <?php if(!empty($arr_mod['active']))echo $arr_mod['active'];?>"> <a href="<?php echo site_url('admin/dashboard');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Dashboard 1 </a> </li>
        <li class="sidenav-link <?php if(!empty($arr_mod['dash2active']))echo $arr_mod['dash2active'];?>"> <a href="<?php echo site_url('admin/dashboard/page2');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Dashboard 2 </a> </li>
        <li class="sidenav-link <?php if(!empty($arr_mod['dash3active']))echo $arr_mod['dash3active'];?>"> <a href="<?php echo site_url('admin/dashboard/page3');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Dashboard 3 </a> </li>
        <li class="sidenav-link <?php if(!empty($arr_mod['dash4active']))echo $arr_mod['dash4active'];?>"> <a href="<?php echo site_url('admin/dashboard/page4');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Dashboard 4 </a> </li>
      </ul>
    </li>
    ...
    <li class="<?php if(!empty($arr_mod['adm_open']))echo $arr_mod['adm_open'];?> treeview"> <a href="#"> <i class="fa fa-building"></i> <span><?php echo $this->lang->line('left_organization');?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">
        ...
        <li class="sidenav-link <?php if(!empty($arr_mod['exp_active']))echo $arr_mod['exp_active'];?>"> <a href="<?php echo site_url('admin/expense');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <span><?php echo $this->lang->line('left_expense');?></span> </a> </li>
        <?php } ?>
      </ul>
    </li>
    <?php } ?>
    ...
    <?php  if(in_array('40',$role_resources_ids) || in_array('41',$role_resources_ids) || in_array('42',$role_resources_ids) || in_array('107',$role_resources_ids) || in_array('108',$role_resources_ids) || $system[0]->module_goal_tracking=='true') {?>
    <li class="<?php if(!empty($arr_mod['performance_open']))echo $arr_mod['performance_open'];?> treeview"> <a href="#"> <i class="fa fa-cube"></i> <span><?php echo $this->lang->line('left_performance');?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">
        ...
        <?php } ?>
        <?php if(in_array('41',$role_resources_ids)) { ?>
        <li class="sidenav-link <?php if(!empty($arr_mod['per_kpi_active']))echo $arr_mod['per_kpi_active'];?>"> <a href="<?php echo site_url('admin/performance_maingoals');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <?php echo $this->lang->line('left_performance_kpi');?> </a> </li>
        <?php } ?>
        <?php if(in_array('41',$role_resources_ids)) { ?>
        <li class="sidenav-link <?php if(!empty($arr_mod['per_rep_active']))echo $arr_mod['per_rep_active'];?>"> <a href="<?php echo site_url('admin/performance_report');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <?php echo $this->lang->line('kpi_report');?> </a> </li>
        <?php } ?>
    ...
    <li class="<?php if(!empty($arr_mod['project_open']))echo $arr_mod['project_open'];?> treeview"> <a href="#"> <i class="fa fa-tasks"></i> <span><?php echo $this->lang->line('xin_project_manager_title');?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">
        ...
        <li class="sidenav-link <?php if(!empty($arr_mod['hr_create_inv_active']))echo $arr_mod['hr_create_inv_active'];?>"> <a href="<?php echo site_url('admin/invoices/create/');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <?php echo $this->lang->line('xin_invoice_create');?> </a> </li>
        <?php } ?>
