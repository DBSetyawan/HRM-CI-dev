          ...
          <!-- User Account: style can be found in dropdown.less -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu <?php echo $animated;?>">
                  ...
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('admin/reports');?>"> <i class="fa fa-bar-chart"></i><?php echo $this->lang->line('xin_hr_report_title');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('92',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('admin/import');?>"> <i class="fa fa-cloud-upload"></i><?php echo $this->lang->line('xin_hr_imports');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('95',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('admin/calendar/hr');?>"> <i class="fa fa-calendar"></i><?php echo $this->lang->line('xin_hr_calendar_title');?></a></li>
                  <?php } ?>
