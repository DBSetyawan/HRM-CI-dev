        ...
        <div class="authfy-container col-xs-12 col-sm-10 col-md-8 col-lg-6 col-sm-offset-1 col-md-offset-2 col-lg-offset-3">
            ...
            <div class="brand-col">
              <div class="headline">
                ...
                <div class="brand-logo">
                  ...
                  <img src="<?php echo base_url();?>uploads/kop_login.jpg" alt="hrsale-logo" width="180px">
                </div><!-- ./brand-logo -->
          ...
          <?php $hidden = array('user_id' => 0);?>
            ...
            <div class="form-group">
                ...
                <a href="<?php echo base_url();?>uploads/manual_kop_online.pdf" target="_blank">Manual KOP</a>
              </div> <!-- ./panel-login -->
            </div>
          </div>
        </div>
