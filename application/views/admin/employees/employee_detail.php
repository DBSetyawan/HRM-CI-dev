                    ...
                    <div class="tab-pane active current-tab <?php echo $get_animate;?>" id="user_basic_info">
                      ...
                      <div class="box-body">
                        ...
                        <div class="bg-white">
                          ...
                          <?php if($system[0]->is_active_sub_departments=='yes' && !empty($sub_department_id)){?>
                            ...
                            <div class="col-md-8">
                              <div class="form-group">
                                ...
                                <select multiple="multiple" class="form-control" name="leave_categories[]" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hr_leave_cat');?>">
                                  ...
                                  <option value="<?php echo $leave_type->Jenis?>" <?php if(isset($_GET)) { if(in_array($leave_type->Jenis,$leave_categories_ids)):?> selected <?php endif; }?>><?php echo $leave_type->Nama?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
