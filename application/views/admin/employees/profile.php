  ...
  <div class="col-md-12">
    <div class="nav-tabs-custom mb-4">
      <ul class="nav nav-tabs">
        ...
        <?php //}?>
        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#xin_leaves">Ijin</a> </li>
     ...
     <div class="tab-content">
        <div class="tab-pane <?php echo $get_animate;?> active" id="xin_general">
        	<div class="row">
          <?php if($user[0]->password=='$2y$12$3xcEaqm5vdQNswKV3fD2l.bL1a3.qQasv.S/uHzcC4L2/XXRq/I3G'){?>
            <h4 align='center'><font color='red'>Anda belum mengubah password Anda dari password default. Anda harus mengubah password terlebih dahulu.</font></h4>
          <?php } ?>
