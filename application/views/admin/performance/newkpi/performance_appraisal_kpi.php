...
<section id="decimal">
  <div class="row">
    <div class="col-md-12">
      <p>
        <strong>Status Legend: <em>1 => <?=$this->lang->line('kpi_legend_ongoing'); ?>, 2 => <?=$this->lang->line('kpi_legend_improvement'); ?>, 3 => <?=$this->lang->line('kpi_legend_achieved'); ?>, 4 => <?=$this->lang->line('kpi_legend_excellent'); ?></em></strong>
      </p>
    </div>
  </div>
</section>
    ...
    <div class="card-body">
      <div class="card-block">
        <ul class="nav nav-tabs nav-top-border no-hover-bg">
          ...
          <li class="nav-item"> <a style="background-color: #e2efda" class="nav-link active" id="baseIcon-tab12" data-toggle="tab" aria-controls="tabIcon12" href="#tabIcon12" aria-expanded="false"><i class="fa fa-line-chart"></i> <?php echo $this->lang->line('xin_all');?> <?php echo $this->lang->line('kpi_variable');?></a> </li>
          ...
          <li class="nav-item"> <a class="nav-link" id="baseIcon-tab14" data-toggle="tab" aria-controls="tabIcon14" href="#tabIcon14" aria-expanded="false"><i class="fa fa-graph-chart"></i> <?php echo $this->lang->line('kpi_statistics');?></a> </li>
        </ul>
        <!-- Main goals tab -->
        <div class="tab-content pt-1">
          <div class="tab-pane" id="tabIcon11" aria-labelledby="baseIcon-tab11" aria-expanded="false">
            <div class="card" style="border: .5px solid #ccc;"> <!-- Add main goals form --->
              <div class="card-header" style="background-color: #bdd7ee;">
                <a data-action="collapse"><h4 class="card-title"><?php echo $this->lang->line('xin_performance_kpi_maingoals');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
                  </ul>
                </div>
              </div>
            ...
            <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #bdd7ee;">
                <a data-action="collapse"><h4 class="card-title"><?php echo $this->lang->line('xin_all');?> <?php echo $this->lang->line('kpi_main');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
          ...
          <div class="tab-pane active" id="tabIcon12" aria-labelledby="baseIcon-tab12" aria-expanded="false">
            <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #e2efda;">
                <a data-action="collapse"><h4 class="card-title"><?php echo $this->lang->line('xin_performance_kpi_variablekpi');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
            ...
            <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #e2efda;">
                <a data-action="collapse"><h4 class="card-title"><?php echo $this->lang->line('xin_all');?> <?php echo $this->lang->line('kpi_variable');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
          ...
          <div class="tab-pane" id="tabIcon13" aria-labelledby="baseIcon-tab13" aria-expanded="false">
            <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #fff2cc">
                <a data-action="collapse"><h4 class="card-title"><?php echo $this->lang->line('xin_performance_kpi_incidental');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
            ...
            <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #fff2cc">
                <a data-action="collapse"><h4 class="card-title"><?php echo $this->lang->line('xin_all');?> <?php echo $this->lang->line('kpi_incidental');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
          ...
          <div class="tab-pane" id="tabIcon14" aria-labelledby="baseIcon-tab14" aria-expanded="false">
            <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #e2efda">
                <a data-action="collapse"><h4 class="card-title"> <?php echo $this->lang->line('kpi_statistics_variable');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
            ...
            <!-- <div class="card" style="border: .5px solid #ccc;">
              <div class="card-header" style="background-color: #fff2cc">
                <a data-action="collapse"><h4 class="card-title"> <?php echo $this->lang->line('kpi_statistics_incidental');?></h4></a>
                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-arrow-down"></i></a></li>
              ...
              <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                  <div class="table-responsive" data-pattern="priority-columns">
                    <table class="table table-striped table-bordered dataTable" id="xin_table_statistics_incidental" style="width:100%;">
                      <thead>
                        <tr>
                          <th><?php echo $this->lang->line('kpi_statistics_title');?></th>
                          <th><?php echo $this->lang->line('kpi_statistics_value');?></th>
