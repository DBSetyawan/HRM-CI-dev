                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group" id="ajx_designation">
                        ...
                        <select disabled="disabled" class="form-control" name="designation_id" data-plugin="select_hrm"  id="filter_designation" data-placeholder="<?php echo $this->lang->line('xin_designation');?>">
                          <option value=""></option>
                        </select>
                      </div>
                    </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th width="330"><i class="fa fa-user"></i> <?php echo $this->lang->line('xin_employee_name');?></th>
