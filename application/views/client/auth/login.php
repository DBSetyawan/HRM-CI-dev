...
<body class="hold-transition login-page" style="background-position: center center; background-size: cover; background-image: url('<?php echo base_url();?>skin/hrsale_assets/img/bg/bg-3.jpg');">
<div class="login-box animated fadeInDownBig"> 
  ...
  <div class="login-box-body">
    ...
    <?php $ilogn_info = 'client1@hrsale.com';?>
	<?php $ilogn_info2 = 'client2@hrsale.com';?>
    ...
    <?php echo form_open('client/auth/login', $attributes, $hidden);?>
    <div class="form-group has-feedback">
      <input type="text" class="form-control" id="iusername" name="iusername" placeholder="<?php echo $this->lang->line('xin_login_email');?>" autocomplete="off">
    ...
    <div class="row">
      <div class="col-xs-8"> <a href="<?php echo site_url('client/auth/forgot_password');?>" class="d-block small"><?php echo $this->lang->line('xin_forgot_password_link');?></a> </div>
      <!-- /.col -->
    ...
    <div class="row">
      <div class="col-xs-8">
        <div class="btn-group">
          <button type="button" class="btn btn-default btn-sm login-as" data-toggle="dropdown" aria-expanded="false" data-username="<?php echo $ilogn_info;?>" data-password="tobias$$##">Login Info</button>
        </div>
      </div>
      <!-- /.col -->
      <div class="col-xs-4">
        <button type="button" class="btn btn-success btn-block btn-flat btn-sm" onClick="window.location='<?php echo site_url('admin/');?>'">Admin Panel </button>
      </div>
      <!-- /.col --> 
    </div>
    <hr>
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrsale_assets/hrsale_scripts/xin_client_login.js"></script> 
<script type="text/javascript">
$(document).ready(function(){
