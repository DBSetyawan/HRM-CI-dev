    ...
    <div class="five columns">        
		...
		<div class="widget">
			...
			<ul class="footer-links search-categories">
                ...
                <?php $count_jobs = $this->Recruitment_model->job_type_record_count($ijob_type->type_url);?>
                <?php if($count_jobs > 0){?>
                <li><a href="<?php echo site_url('jobs/search/type/').$ijob_type->type_url;?>"><?php echo $ijob_type->type;?> (<?php echo $this->Recruitment_model->job_type_record_count($ijob_type->type_url);?>)</a></li>
                <?php } ?>
				<?php endforeach;?>
			</ul>
		</div>
